...
void track(LightTrack *siam_tracker, const char *video_path)
{
    ...
    out.open("./out.avi", codec, out_fps,frame.size(), isColor);
...
int main(int argc, char** argv)
{
    ...
    // Get model path.
    std::string init_model = "model/lighttrack_init.precompile.rknn";
    std::string backbone_model = "model/lighttrack_backbone.precompile.rknn";
    std::string neck_head_model = "model/lighttrack_neck_head.precompile.rknn";
